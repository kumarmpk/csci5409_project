  ...
  render() {
    ...
    return (
      <form onSubmit={this.handleSubmit} className="ui form" >
        <div className="field">
          <label>Part Id</label>
          <input type="number" name="partId" value={partId} onChange={this.handleChange} />
        </div>
        <div className="field">
          <label>Part Name</label>
          <input type="text" name="partName" value={partName} onChange={this.handleChange} />
        </div>
        <div className="field">
          <label>Qoh</label>
          <input type="number" name="qoh" value={qoh} onChange={this.handleChange} />
        </div>
        <input className="ui button" name="submit" type="submit" value={usage === 'update' ? "Update" : "Create"} />
        <br />
        <div className={message.length > 15 ? "red message" : "green message"}>{message}</div>
      </form>
    )
  }
}
